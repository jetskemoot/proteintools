...
The goal of proteintools is to provide convenient functions for basic protein and DNA sequence analysis. This package was developed as part of a data science for biology 2 portfolio project at Hogeschool Utrecht.

## Installation

You can install the development version of proteintools from [GitHub](https://github.com/) with:
